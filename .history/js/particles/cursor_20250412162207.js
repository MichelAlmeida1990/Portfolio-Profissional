document.addEventListener('DOMContentLoaded', () => {
  ...
  // Eventos de hover em elementos clicáveis (excluindo elementos de navegação)
  const clickableElements = document.querySelectorAll('a:not(.nav-item):not(.menu-hamburger), button:not(.menu-hamburger), [role="button"]:not(.menu-hamburger), input[type="submit"], .clickable');
